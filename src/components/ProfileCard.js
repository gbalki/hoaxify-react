                ...
                {inEditMode && (
                    <div>
                        ...
                        <div className='mt-1'>
                            ...
                            />
                            <button className='btn btn-light d-inline-flex ms-1' onClick={() => setInEditMode(false)} disabled={pendingApiCall}><i className='material-icons'>close</i>{t('Cancel')}</button>
                        </div>
                    </div>
                )}
            </div>
